...
#define ACCL_TOP_CSR_RETURNDATA_REG (0x20)
#define ACCL_TOP_CSR_ARG_A_REG (0x28)
#define ACCL_TOP_CSR_ARG_B_REG (0x30)

/* Argument Sizes (bytes) */
#define ACCL_TOP_CSR_RETURNDATA_SIZE (4)
#define ACCL_TOP_CSR_ARG_A_SIZE (4)
#define ACCL_TOP_CSR_ARG_B_SIZE (4)

/* Argument Masks */
#define ACCL_TOP_CSR_RETURNDATA_MASK (0xffffffff)
#define ACCL_TOP_CSR_ARG_A_MASK (0xffffffff)
#define ACCL_TOP_CSR_ARG_B_MASK (0xffffffff)
