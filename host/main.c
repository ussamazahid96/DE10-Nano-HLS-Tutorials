...
char rbf_file [32] = "DE10_NANO.rbf";
...
int main(int argc, const char * argv[])
{
  ...
  if(argc > 1) {
    ...
    else if(strcmp(argv[1], "set_cfgwdth") == 0)     set_cfgwdth();
...
// This is a config for MSEL[4..0] = 01010
{
  ...
  control_reg = INSERT_BITS(control_reg, cfgwdth_mask, cfgwdth, 9);
  alt_write_hword(virtualbase + CTRL_OFFSET, control_reg);

  printf("%s 0x%x.\n", "Setting cfgwdth with", cfgwdth);
}
