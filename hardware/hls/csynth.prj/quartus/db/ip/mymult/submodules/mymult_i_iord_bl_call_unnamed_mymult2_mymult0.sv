...
// SystemVerilog created from mymult_i_iord_bl_call_unnamed_mymult2_mymult0
...
module mymult_i_iord_bl_call_unnamed_mymult2_mymult0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_mymult_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_mymult_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_mymult_i_fifodata),
    ...
    assign out_iord_bl_call_mymult_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,14)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,16)
    assign out_iord_bl_call_mymult_o_fifoready = iord_o_fifoready;
