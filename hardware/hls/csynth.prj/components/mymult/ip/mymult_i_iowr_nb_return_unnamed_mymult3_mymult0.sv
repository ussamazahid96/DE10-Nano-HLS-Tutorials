...
// SystemVerilog created from mymult_i_iowr_nb_return_unnamed_mymult3_mymult0
...
module mymult_i_iowr_nb_return_unnamed_mymult3_mymult0 (
    ...
    assign out_iowr_nb_return_mymult_o_fifodata = iowr_nb_o_fifodata;
    assign out_iowr_nb_return_mymult_o_fifovalid = iowr_nb_o_fifovalid;
